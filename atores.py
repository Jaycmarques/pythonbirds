...
class Passaro(Ator):
    ...
    def _calcular_posicao_vertical(self, delta_t):
        ...
        angulo_radianos = self._angulo_de_lancamento # type: ignore
        y_atual += self.velocidade_escalar_padrao * delta_t * math.sin(angulo_radianos)
    ...
    def _calcular_posicao_horizontal(self, delta_t):
        ...
        angulo_radianos = self._angulo_de_lancamento # type: ignore
        x_atual += self.velocidade_escalar_padrao * delta_t * math.cos(angulo_radianos)
        self.x = x_atual
